        ...
        default:
          ...
          if (mediaMap.isNotEmpty) {
            ...
            for (var i = 0; i < mediaMap.length; i++) {
              bytes.add(await io.File(mediaMap.entries.elementAt(i).key)
                  .readAsBytes());
            }
            ...
            for (var i = 0; i < bytes.length; i++) {
              if (i == 0) {
                archive
                    .addFile(ArchiveFile(fileName, bytes[i].length, bytes[i]));
              } else {
            ...
            if (encodedFile != null) {
              ...
              await io.File(
                      '${directory.path}/${fileName.split(extension)[0]}zip')
